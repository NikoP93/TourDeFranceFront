// import { fetchAnyUrl, putObjectAsJson, fillTeamsDropdown } from "./modulejson.js";
//
...
//
//     const resp = await putObjectAsJson(url, plainFormData, "PUT");
//     if (!resp.ok) {
...
//     editRiderForm.style.display = "block";
